  ...
  return (
    <div class="mb-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-10">
        <nav class="pb-10 md:border-r-1.5 md:col-span-3 lg:col-span-2 order-2 md:order-1 border-t-1.5 border-jsr-cyan-900 md:border-t-0 md:border-slate-300 md:dark:border-jsr-cyan-900 pt-4 md:pt-0">
          <div>
                ...
                {files.map(({ id, title }) => (
                  <li>
                    <a
                      ...
                      class={`${
                        id === data.id
                          ? "px-4 text-jsr-cyan-700 dark:text-jsr-cyan-300 border-l-4 border-jsr-cyan-400 bg-jsr-cyan-100 dark:bg-jsr-cyan-800"
                          : "pl-5 pr-4"
                      } py-1.5 block leading-5 hover:text-jsr-gray-600 dark:hover:text-jsr-cyan-200 hover:underline`}
                    >
                      {title}
                    </a>
                  </li>
