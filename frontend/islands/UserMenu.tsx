      ...
      >
        ...
        <div class="divide-y divide-slate-200">
          <a
            href="/new"
            tabIndex={open ? undefined : -1}
            class={`${SHARED_ITEM_CLASSES} font-bold bg-jsr-yellow dark:bg-jsr-yellow-600 border-jsr-yellow dark:border-jsr-yellow-600 hover:bg-jsr-yellow-300 hover:dark:bg-jsr-yellow-700 hover:border-jsr-cyan-500 hover:border-jsr-cyan-500 focus-visible:bg-jsr-yellow-300 focus-visible:border-jsr-yellow-300 ring-black`}
          >
            <TbPlus class="size-5" />
            Publish a package
          </a>
