  ...
  return {
    ...
    content: (
      <div class="grow-1 w-full flex flex-col md:flex-row gap-2 justify-between">
        <div class="grow-1">
          <div class="flex flex-wrap items-baseline gap-2 dark:text-jsr-cyan-300 group-focus:dark:text-jsr-cyan-900 group-hover:dark:text-jsr-cyan-900">
          ...
          <div class="text-sm text-jsr-gray-500 dark:text-jsr-gray-200 group-focus:dark:text-jsr-cyan-800 group-hover:dark:text-jsr-cyan-800">
            {pkg.description}
          </div>
        </div>
